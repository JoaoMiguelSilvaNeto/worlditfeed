...
$(document).ready(function(){
	...
	$("#category").getCtrl().wix-options({title: 'Category', defaultValue: 'Noticias', options: [{ value: 'Noticias', label: 'Notícias'},{ value: 'Tweets', label: 'Tweets'},{ value: 'Outras', label: 'Outras'}]});
	//getValue function
